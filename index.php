...
<meta name="description" content="Over 23000 WordPress plugins have been contributed to the WordPress.org Plugin Directory. This table showcases the 108 most popular WordPress plugins, ranked by the number of downloads." />
...
<meta property="og:description" content="Over 23000 WordPress plugins have been contributed to the WordPress.org Plugin Directory. This table showcases the 108 most popular WordPress plugins, ranked by the number of downloads." />
<meta property="fb:app_id" content="249269275090337" />
<link href="https://plus.google.com/103365919153496720927/" rel="author" />
<link href="https://plus.google.com/106123086594493830713/" rel="publisher" />
<!--
	...
	<div class="toolbar-inner">
		<div class="social-links">
			...
			<div class="button twitter">
				<a href="https://twitter.com/share" class="twitter-share-button" data-via="swissspidy">Tweet</a>
				<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
			</div>
		</div>
		<div class="info-text">
			<a href="http://mad.ly/signups/70846/join" target="_blank" title="Subscribe to our mailing list!"><p>Curious about future updates? Subscribe to our <span>mailing list</span> for more information!</p></a>
		</div>
	</div>
</div>
<div class="wrapper">
	...
	<aside class="infobox">
		...
		<div class="intro">
			...
			<div class="description">
				<p>
					Around <strong>30&lsquo;000 WordPress plugins</strong> have been contributed to the <a href="http://wordpress.org/plugins/" target="_blank">WordPress.org Plugin Directory</a>.
		...
		<div class="tooltip right hidden">
			<div class="tooltip-inner">
				<div class="upper-wrap">
					<div class="name"><a href="<?php echo get_plugin_url( $plugin['slug'] ); ?>" title="<?php echo $plugin['name']; ?>" target="_blank"><?php echo $plugin['name']; ?></a></div>
